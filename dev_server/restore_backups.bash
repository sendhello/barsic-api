...
echo 'Restore database rk7'
docker exec -it dev_server_bars_db_1 /opt/mssql-tools/bin/sqlcmd \
   -S localhost -U SA -P 'MSSQL@1234' \
   -Q 'RESTORE DATABASE RK7 FROM DISK = "/var/opt/mssql/backup/RK7.bak" WITH MOVE "RK7" TO "/var/opt/mssql/data/RK7.mdf", MOVE "RK7_log" TO "/var/opt/mssql/data/RK7_log.ldf"'
